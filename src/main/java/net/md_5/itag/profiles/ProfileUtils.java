...
public class ProfileUtils {
     ...
     * Returns null if the player with the specified uuid doesn't exist
     * </p>
     * 
     * @param name look for a profile with this name
     * @return a profile with the given name, or null if there is no player with the specified username
     */
     ...
     * @return a profile with the given id or null if there is no player with the specified id
     */
    ...
    private static PlayerProfile lookupProperties(UUID id) {
        ...
        Object rawResponse = getJson("https://sessionserver.mojang.com/session/minecraft/profile/" + id.toString().replace("-", "") + "?unsigned=false");
